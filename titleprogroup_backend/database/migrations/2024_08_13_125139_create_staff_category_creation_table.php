...
return new class extends Migration
{
    ...
    {
        Schema::create('staff_category_creation', function (Blueprint $table) {
            $table->id();
            $table->date('entry_date')->nullable();
            $table->string('staff_category_name', 100)->nullable();
    ...
    {
        Schema::dropIfExists('staff_category_creation');
    }
};
