...
return new class extends Migration
{
    ...
    {
        Schema::create('county_creation', function (Blueprint $table) {
            $table->id();
            $table->string('county_name', 100)->nullable();
            $table->string('county_code', 100)->nullable();
            $table->string('county_mobile_code', 100)->nullable();
    ...
    {
        Schema::dropIfExists('county_creation');
    }
};
